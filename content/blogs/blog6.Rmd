...
#Add labels
  labs(title="Estimating Net Approval (approve-disapprove) for Barack Obama",subtitle="Weekly average of all polls",x="Week of the year",y="Average net approval (%)", caption = "Source:TheHuffingtonPost") +
#Remove legend
...
",subtitle="Weekly average of all polls",x="Week of the year",y="Average net approval (%)", caption = "Source:FiveThirtyEight") +
#Remove legend
  theme(legend.position = "none")
